...
public class EventManagerClient extends managerInterfacePOA {
	...
	public String requestOnOtherServer(String managerId, String eventId, String eventType, String eventCapacity,
		...
		try {
			String requestData = generateJSONObject(managerId, eventId, eventType, eventCapacity, port, operation);
			// String requestData = managerId + "," + eventId + "," + eventType + "," +
			// eventCapacity + "," + operation;
	...
	static String generateJSONObject(String id, String eventId, String eventType, String eventCapacity, int port,
			String operation) {
		JSONObject obj = new JSONObject();
		obj.put("id", id.trim());
		obj.put("eventId", eventId.trim());
		obj.put("eventType", eventType.trim());
		obj.put("eventCapacity", eventCapacity.trim());
		obj.put("port", new Integer(port));
		obj.put("operation", operation.trim());
		return obj.toString();
	}
