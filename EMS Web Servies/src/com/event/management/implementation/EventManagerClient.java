...
@WebService(endpointInterface = "com.event.management.implementation.EventManagerInterface")
@SOAPBinding(style = SOAPBinding.Style.RPC)

public class EventManagerClient implements EventManagerInterface {
